...
public class ExampleClient {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        WordLadderGame doublets = new Doublets(new FileInputStream(new File("/Users/admin/Desktop/COMP-2210/M6/Assignment 6/src/sowpods.txt")));
//
...
//
        System.out.println(doublets.getMinLadder("tiger", "fryer"));
    }
}
...
[tiger, liger, lager, layer, fayer, fryer]
